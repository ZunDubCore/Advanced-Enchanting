...
public class ButtonItemStack extends ExtendedButton {
    ...
    public ButtonItemStack(int x, int y, int width, int height, String text, ItemStack renderStack,
            IPressable handler) {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        if (!stack.isEmpty()) {
            ...
            minecraft.getItemRenderer().renderItemOverlayIntoGUI(minecraft.fontRenderer, stack,
                    this.x + 2, this.y + 2, "");
